defmodule MusicManagement.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, MusicManagement.Repo)
  ...
  """
  def valid_password?(%MusicManagement.Accounts.User{hashed_password: hashed_password}, password)
