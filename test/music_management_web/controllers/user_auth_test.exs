defmodule MusicManagementWeb.UserAuthTest do
  use MusicManagementWeb.ConnCase, async: true

  alias MusicManagement.Accounts
  alias MusicManagementWeb.UserAuth
  import MusicManagement.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MusicManagementWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MusicManagementWeb.Endpoint.subscribe(live_socket_id)
